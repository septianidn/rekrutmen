...
const templates = {
    pendidikan: (i) => `<div class="row mb-3 item-row">
        ...
        <div class="col-md-4"><label class="form-label">Instansi</label><input type="text" name="pendidikan[${i}][instansi]" class="form-control"></div>
        <div class="col-md-2"><label class="form-label">IPK/Nilai</label><input type="text" name="pendidikan[${i}][indeks_nilai]" class="form-control"></div>
        <div class="col-md-3"><label class="form-label">Keterangan</label><input type="text" name="pendidikan[${i}][keterangan]" class="form-control"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
    kerja: (i) => `<div class="row mb-3 item-row">
        <div class="col-md-11"><label class="form-label">Keterangan</label><textarea name="kerja[${i}][keterangan]" class="form-control" rows="2"></textarea></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
    organisasi: (i) => `<div class="row mb-3 item-row">
        <div class="col-md-4"><label class="form-label">Nama Organisasi</label><input type="text" name="organisasi[${i}][nama_organisasi]" class="form-control"></div>
        <div class="col-md-3"><label class="form-label">Jabatan</label><input type="text" name="organisasi[${i}][jabatan]" class="form-control"></div>
        <div class="col-md-4"><label class="form-label">Keterangan</label><input type="text" name="organisasi[${i}][keterangan]" class="form-control"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
    prestasi: (i) => `<div class="row mb-3 item-row">
        <div class="col-md-6"><label class="form-label">Nama Penghargaan</label><input type="text" name="prestasi[${i}][nama_penghargaan]" class="form-control"></div>
        <div class="col-md-2"><label class="form-label">Tahun</label><input type="text" name="prestasi[${i}][tahun]" class="form-control" maxlength="4"></div>
        <div class="col-md-3"><label class="form-label">Dokumen</label><input type="text" name="prestasi[${i}][dokumen]" class="form-control"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
    pelatihan: (i) => `<div class="row mb-3 item-row">
        <div class="col-md-5"><label class="form-label">Nama Pelatihan</label><input type="text" name="pelatihan[${i}][nama_pelatihan]" class="form-control"></div>
        <div class="col-md-2"><label class="form-label">Tahun</label><input type="text" name="pelatihan[${i}][tahun]" class="form-control" maxlength="4"></div>
        <div class="col-md-4"><label class="form-label">Sertifikat</label><input type="text" name="pelatihan[${i}][sertifikat]" class="form-control"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
    bahasa: (i) => `<div class="row mb-3 item-row">
        <div class="col-md-5"><label class="form-label">Bahasa</label><input type="text" name="bahasa[${i}][bahasa]" class="form-control"></div>
        <div class="col-md-6"><label class="form-label">Keterangan (level)</label><input type="text" name="bahasa[${i}][keterangan]" class="form-control"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
    rekomendasi: (i) => `<div class="row mb-3 item-row">
        <div class="col-md-3"><label class="form-label">Nama</label><input type="text" name="rekomendasi[${i}][nama_perekomendasi]" class="form-control"></div>
        <div class="col-md-2"><label class="form-label">Posisi</label><input type="text" name="rekomendasi[${i}][posisi]" class="form-control"></div>
        <div class="col-md-3"><label class="form-label">No HP</label><input type="text" name="rekomendasi[${i}][no_hp]" class="form-control"></div>
        <div class="col-md-3"><label class="form-label">Alamat</label><input type="text" name="rekomendasi[${i}][alamat]" class="form-control"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="this.closest('.item-row').remove()">X</button></div>
    </div>`,
};
