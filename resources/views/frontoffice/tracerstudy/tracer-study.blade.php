        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-12 counter-col">
                    <div class="counter-RANDOM"> <span class="counter-value" data-vanilla-counter=""
                            data-start-at="0" data-end-at="53" data-time="1000" data-delay="60"
                            data-format="{}+"></span> </div>
                    <div class="counter-text">Lulusan D3</div>
                </div>
                <div class="col-lg-3 col-md-3 col-12 counter-col">
                    <div class="counter-RANDOM "> <span class="counter-value" data-vanilla-counter=""
                            data-start-at="0" data-end-at="20" data-time="1000" data-delay="60"
                            data-format="{}K+"></span></div>
                    <div class="counter-text">Lulusan S1</div>
                </div>
                <div class="col-lg-3 col-md-3 col-12 counter-col">
                    <div class="counter-RANDOM"> <span class="counter-value" data-vanilla-counter=""
                            data-start-at="0" data-end-at="18" data-time="1000" data-delay="60"
                            data-format="{}K+"></span> </div>
                    <div class="counter-text">Lulusan</div>
                </div>
                <div class="col-lg-3 col-md-3 col-12 counter-col">
                    <div class="counter-RANDOM"> <span class="counter-value" data-vanilla-counter=""
                            data-start-at="0" data-end-at="5" data-time="1000" data-delay="60"
                            data-format="{}"></span> </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img"
                                            src="{{ asset('images/frontoffice/about/xsmall1.jpg') }}"
                                            alt="#" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img mt-50"
                                            src="{{ asset('images/frontoffice/about/xsmall2.jpg') }}"
                                            alt="#" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <img class="single-img minus-margin"
                                            src="{{ asset('images/frontoffice/about/xsmall3.jpg') }}"
                                            alt="#" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-6">
