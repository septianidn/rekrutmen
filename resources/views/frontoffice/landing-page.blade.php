        ...
        <div class="hero-inner">
            <div class="home-slider">
                <div class="single-slider">
                    <img class="slider-background" src="{{ asset('images/frontoffice/hero/unand.jpg') }}" alt="#" />
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="inner-content">
                                    <div class="hero-text">
                                        ...
                                        <p class="wow fadeInUp text-white" data-wow-delay=".5s">
                                            Lorem ipsum dolor sit amet consectetur. Sit est porttitor platea tellus
                                            luctus sagittis. Eget eget sit quam nam. Netus condimentum pretium nulla
                                            nisi est purus lorem nec. Nulla malesuada lorem urna est. Diam consectetur
                                            vel vestibulum leo amet gravida in aliquam. Nulla turpis sit turpis aliquet.
                                            Tincidunt tempor odio proin erat pellentesque. Risus massa leo habitant nisl
                                            enim mus sed. Eget mauris tristique tempor lectus lectus massa ac nec morbi.
                                        </p>
                ...
                <div class="single-slider">
                    <img class="slider-background" src="{{ asset('images/frontoffice/hero/unand.jpg') }}"
                        alt="#" />
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 co-12">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="job-content">
                                ...
                                <ul>
                                    <li>
                                        <i class="lni lni-website"></i><a href="#"> winbrans.com</a>
                                    </li>
                        ...
                        <div class="single-job wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="job-content">
                                ...
                                <ul>
                                    <li>
                                        <i class="lni lni-website"></i><a href="#"> designhub.com</a>
                                    </li>
                                    <li><i class="lni lni-dollar"></i> $20k - $25k</li>
                        ...
                        <div class="single-job wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="job-content">
                                ...
                                <ul>
                                    <li>
                                        <i class="lni lni-website"></i><a href="#"> uddesign.com</a>
                                    </li>
                                    <li><i class="lni lni-dollar"></i> $20k - $25k</li>
                        ...
                        <div class="single-job wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="job-content">
                                ...
                                <ul>
                                    <li>
                                        <i class="lni lni-website"></i><a href="#"> webinner.com</a>
                                    </li>
                                    <li><i class="lni lni-dollar"></i> $20k - $25k</li>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="single-job wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="job-content">
                                ...
                                <ul>
                                    <li>
                                        <i class="lni lni-website"></i><a href="#"> marketers.com</a>
                                    </li>
                                    <li><i class="lni lni-dollar"></i> $20k - $25k</li>
                        ...
                        <div class="single-job wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="job-content">
                                ...
                                <ul>
                                    <li>
                                        <i class="lni lni-website"></i><a href="#"> androidplex.com</a>
                                    </li>
                                    <li><i class="lni lni-dollar"></i> $20k - $25k</li>
                                    <li><i class="lni lni-map-marker"></i> Cupertino, USA</li>
                                </ul>
    ...
    <div class="latest-news-area section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <span class="wow fadeInDown" data-wow-delay=".2s">Publikasi Terkini</span>
                        <h2 class="wow fadeInUp" data-wow-delay=".4s">
                            Artikel dan Berita
                        </h2>
                        <p class="wow fadeInUp" data-wow-delay=".6s">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-news wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="content-body">
                            <h4 class="title">
                                <a href="blog-single.html">The Internet Is A Job Seeker Most Crucial Success</a>
                            </h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="single-news wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="content-body">
                            <h4 class="title">
                                <a href="blog-single.html">Today From Connecting With Potential Employers</a>
                            </h4>
                            <div class="meta-details">
                                <ul>
                                    <li>
