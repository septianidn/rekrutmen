                        ...
                        <form id="job-form" action="{{route('employer.job.update', ['job'=>$jobs->id])}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label>Posisi</label>
                                        <input class="form-control" type="text" name="posisi" list="posisi-options" value="{{ old('posisi', $jobs->posisi?->nama_posisi) }}" autocomplete="off" placeholder="Pilih atau ketik posisi">
