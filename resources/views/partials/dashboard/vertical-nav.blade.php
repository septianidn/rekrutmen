<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-kelola-datamaster" data-bs-parent="#sidebar-kelola-datamaster">
            <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('send.create'))}}" aria-current="page" href="{{route('send.create')}}">
            <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('outbox.index'))}}" aria-current="page" href="{{route('outbox.index')}}">
            <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('template.index'))}}" aria-current="page" href="{{route('template.index')}}">
            <i class="icon">
