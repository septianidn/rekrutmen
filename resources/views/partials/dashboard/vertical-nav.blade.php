<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    {{-- START KELOLA LOWONGAN SECTION --}}
    <li class="nav-item">
        <a class="nav-link {{ activeRoute(route('backoffice.job.index')) }}" aria-current="page"
            href="{{ route('backoffice.job.index') }}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4" d="M20 7h-4V5a3 3 0 0 0-3-3h-2a3 3 0 0 0-3 3v2H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2Zm-9-2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2h-4V5Z" fill="currentColor"/>
                    <path d="M22 11v4a1 1 0 0 1-.55.89A14.92 14.92 0 0 1 14 17h-4a14.92 14.92 0 0 1-7.45-1.11A1 1 0 0 1 2 15v-4Z" fill="currentColor"/>
                </svg>
            </i>
            <span class="item-name">Kelola Lowongan</span>
        </a>
    </li>
    {{-- END KELOLA LOWONGAN SECTION --}}
