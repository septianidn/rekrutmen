<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('rekap.index'))}}" aria-current="page" href="{{route('rekap.index')}}">
            <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('role-permission.index'))}}" href="{{route('role-permission.index')}}" target="_blank">
            <i class="icon">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
