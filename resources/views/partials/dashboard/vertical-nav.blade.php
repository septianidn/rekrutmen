<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        <a class="nav-link {{activeRoute(route('laporan-tracer-study.index'))}}" aria-current="page" href="{{route('laporan-tracer-study.index')}}">
            <i class="icon">
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-kelola-datamaster" data-bs-parent="#sidebar-kelola-datamaster">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('datapedia.index'))}}" href="{{route('datapedia.index')}}">
                   <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
