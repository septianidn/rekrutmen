<div class="flex align-items-center list-email-outbox-action">
    <a class="btn btn-sm btn-icon btn-info" data-bs-toggle="modal" data-bs-target="#showDetailOutbox{{$data->id}}" title="Edit fakultas">
...
function showDeleteConfirmation(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.action = "{{route('outbox.destroy', '')}}/" + id;
            form.method = 'POST';
