<div class="flex align-items-center list-email-template-action">
    <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#showDetailTemplate{{$data->id}}" title="Edit fakultas">
    ...
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Edit Template" href="{{ route('backoffice.template.edit', $data->id) }}">
        <span class="btn-inner">
