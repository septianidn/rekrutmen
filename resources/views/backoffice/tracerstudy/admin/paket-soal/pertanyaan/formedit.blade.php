    ...
    <div>
        ...
        <div class="fieldset-wizard-slider">
            <div id="page-container" class="fieldset-wizard-container">
                ...
                @foreach ($data as $key => $halamanPertanyaan)
                    <fieldset class="fieldset-wizard padding-10" id="page[{{ $key }}]">
                        <div class="form-card text-start">
                            <div class="row">
                                <input type="text" class="h3 px-2  mx-2 mb-4 dynamic-input"
                                    id="nama_halaman[{{ $key }}]"
                                    name="data[{{ $key }}][nama_halaman]"
                                    value="{{ $halamanPertanyaan['nama_halaman'] }}" style="transition: width 0.2s;">
                                <input type="hidden" class="h3 px-2  mx-2 mb-4 dynamic-input"
                                    id="urutan[{{ $key }}]" name="data[{{ $key }}][urutan]"
                                    value="{{ $key + 1 }}">

                                <div class="col-sm-12 col-lg-12 card_container"
                                    id="card_container[{{ $key }}]">
                                    @foreach ($halamanPertanyaan['pertanyaan'] as $keyP => $pertanyaan)
                                        <div class="card card-soal" data-aos="fade-down" data-aos-delay="500"
                                            data-page="{{ $key }}" data-id="{{ $keyP }}"
                                            id="card-soal[{{ $key }}][{{ $keyP }}]">
                                            <div class="d-flex justify-content-center align-items-center drag-icon"
                                                id="drag-icon[{{ $key }}][{{ $keyP }}]">
                                                <svg width="25px" height="20px" viewBox="0 0 15 15" fill="none"
                                                    ...
                                                    8.94772 13.5 9.5C13.5 10.0523 13.0523 10.5 12.5 10.5C11.9477 10.5 11.5 10.0523 11.5 9.5Z" fill="#d1d2d1">
                                                        </path>
                                                    </g>
                                                </svg>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-10">
                                                        <label class="form-label text-black">Pertanyaan

                                                            <span class="text-danger">*</span></label>
                                                        <textarea class="form-control pertanyaan-textarea"
                                                            name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan]" placeho lder="Isi Pertanyaan"
                                                            id="pertanyaan[{{ $key }}][{{ $keyP }}]">{{ $pertanyaan['pertanyaan'] }}</textarea>
                                                        <input type="hidden" class="urutan-card"
                                                            name="data[{{ $key }}][pertanyaan][{{ $keyP }}][urutan]"
                                                            value="{{ $keyP + 1 }}"
                                                            id="urutan-card[{{ $key }}][{{ $keyP }}]">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2 col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Kode Pertanyaan" maxlength="15"
                                                                id="kode_soal[{{ $key }}][{{ $keyP }}]"
                                                                name="data[{{ $key }}][pertanyaan][{{ $keyP }}][kode_soal]"
                                                                value="{{ $pertanyaan['kode_soal'] }}">

                                                        </div>

                                                        <div class="selectTypeJawaban_div"
                                                            id="selectTypeJawaban_div[{{ $key }}][{{ $keyP }}]">
                                                            <label class="form-label text-black">Tipe Pertanyaan<span
                                                                    class="text-danger">*</span></label>
                                                            <select class="form-select type-jawaban-select"
                                                                aria-label="Actions" data-placeholder="Pilih Tipe"
                                                                id="selectTypeJawaban[{{ $key }}][{{ $keyP }}]"
                                                                name="data[{{ $key }}][pertanyaan][{{ $keyP }}][tipe_pertanyaan]">

                                                                <option value="general" class="shortanswer"
                                                                    id="shortanswer_type[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="shortanswer_input[{{ $key }}][{{ $keyP }}]"
                                                                    ...
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'general' ? 'selected' : '' }}>
                                                                    Jawaban Singkat
                                                                </option>
                                                                <option value="paragraph" class="paragraph"
                                                                    id="paragraph_type[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="paragraph_input[{{ $key }}][{{ $keyP }}]"
                                                                    ...
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'general' && $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'paragraph' ? 'selected' : '' }}>
                                                                    Paragraf

                                                                </option>
                                                                <option value="single" class="singlechoice"
                                                                    id="singlechoice_type[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="singlechoice_div[{{ $key }}][{{ $keyP }}]"
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'general_option' && $pertanyaan['pertanyaan_general_option'][0]['tipe'] == 'single' ? 'selected' : '' }}
                                                                ...
                                                                <option value="mutiple" class="checkbox"
                                                                    id="checkbox_type[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="checkbox_div[{{ $key }}][{{ $keyP }}]"
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'general_option' && $pertanyaan['pertanyaan_general_option'][0]['tipe'] == 'mutiple' ? 'selected' : '' }}
                                                                ...
                                                                <option value="dropdown" class="dropdown"
                                                                    id="dropdown_type[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="dropdown_div[{{ $key }}][{{ $keyP }}]"
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'dropdown' ? 'selected' : '' }}
                                                                ...
                                                                <option value="grid_option" class="grid_option"
                                                                    id="gridcolumn_type[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="gridcolumn_div[{{ $key }}][{{ $keyP }}]"
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'grid_option' ? 'selected' : '' }}
                                                                ...
                                                                <option value="zone" class="zone"
                                                                    id="zona[{{ $key }}][{{ $keyP }}]"
                                                                    data-input="zona_div[{{ $key }}][{{ $keyP }}]"
                                                                    {{ $pertanyaan['tipe_pertanyaan'] == 'zone' ? 'selected' : '' }}
                                                        ...
                                                        <div class="validation_div"
                                                            id ="validation_div[{{ $key }}][{{ $keyP }}]">
                                                            @if (isset($pertanyaan['pertanyaan_general']) &&
                                                                    $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] != 'paragraph')
                                                                <div class="validation_short_input"
                                                                    id="validation_short_input[{{ $key }}][{{ $keyP }}]">
                                                                    <div class="form-group inputtype shortanswer-validation-div"
                                                                        id="shortanswer_validation_div[{{ $key }}][{{ $keyP }}]">
                                                                        <div class="form-group mt-4"
                                                                            id="shortanswer_input_type_div[{{ $key }}][{{ $keyP }}]">
                                                                            <p class="mt-2"> Silahkan isi validasi
                                                                                disini
                                                                                <span class="text-danger">*</span>
                                                                            </p>
                                                                            <label class="form-label text-black">Tipe
                                                                                Validasi</label>
                                                                            <select
                                                                                class="form-select type-validation-select"
                                                                                name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general][tipe_pertanyaan_general]"
                                                                                id="shortanswer-type-validation[{{ $key }}][{{ $keyP }}]"
                                                                                {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'short_answer' ? 'selected' : '' }}>

                                                                                <option value="short_answer">
                                                                                    Tidak Ada
                                                                                </option>
                                                                                <option value="email"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'email' ? 'selected' : '' }}>
                                                                                    Email</option>
                                                                                <option value="tel"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'tel' ? 'selected' : '' }}>
                                                                                    Nomor Handphone

                                                                                </option>
                                                                                <option value="url"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'url' ? 'selected' : '' }}>
                                                                                    URL</option>
                                                                                <option value="number"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'number' ? 'selected' : '' }}>
                                                                                    Angka Saja</option>
                                                                                <option value="letters"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'letters' ? 'selected' : '' }}>
                                                                                    Huruf Saja</option>
                                                                                Date</option>
                                                                                <option value="time"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'time' ? 'selected' : '' }}>
                                                                                    Time</option>
                                                                                <option value="datetime-local"
                                                                                    {{ $pertanyaan['pertanyaan_general']['tipe_pertanyaan_general'] == 'datetime-local' ? 'selected' : '' }}>
                                                                                    Datetime
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-6 form-group"
                                                                                id="shortanswer-input-max-div[{{ $key }}][{{ $keyP }}]">
                                                                                <label
                                                                                    class="form-label  text-black">Max
                                                                                    Karakter</label>
                                                                                <input type="number"
                                                                                    class="form-control"
                                                                                    placeholder="255" value="255"
                                                                                    min="1"
                                                                                    id="shortanswer-input-max[{{ $key }}][{{ $keyP }}]"
                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general][max_character_jawaban]"
                                                                                    value="{{ $pertanyaan['pertanyaan_general']['max_character_jawaban'] }}">
                                                                            </div>
                                                                            <div class="col-6 form-group"
                                                                                id="shortanswer-input-min-div[{{ $key }}][{{ $keyP }}]">
                                                                                <label
                                                                                    class="form-label  text-black">Min
                                                                                    Karakter</label>
                                                                                <input type="number" min="0"
                                                                                    class="form-control"
                                                                                    placeholder="-"
                                                                                    id="shortanswer-input-min[{{ $key }}][{{ $keyP }}]"
                                                                                    value="{{ $pertanyaan['pertanyaan_general']['min_character_jawaban'] }}"
                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general][min_character_jawaban]">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-10 ">
                                                        ...
                                                        <div class="jawaban_div"
                                                            id="jawaban-div[{{ $key }}][{{ $keyP }}]">
                                                            @if (isset($pertanyaan['pertanyaan_general_option']) &&
                                                                    is_array($pertanyaan['pertanyaan_general_option']) &&
                                                                    count($pertanyaan['pertanyaan_general_option']) > 0)
                                                                @if ($pertanyaan['pertanyaan_general_option'][0]['tipe'] == 'single')
                                                                    <div class="form-group inputtype radio-option-div"
                                                                        id="singlechoice_div[{{ $key }}][{{ $keyP }}]">
                                                                        <p> Silahkan isi opsi pilihan ganda dibawah ini
                                                                            <span class="text-danger">*</span>
                                                                        </p>
                                                                        @foreach ($pertanyaan['pertanyaan_general_option'] as $keyR => $pertanyaanGeneralOption)
                                                                            <div class="radio-option singlechoice_option_div"
                                                                                id="singlechoice_option_div[{{ $key }}][{{ $keyP }}][{{ $keyR }}]">
                                                                                        ...
                                                                                        <div class="row no-gutters">
                                                                                            <div class="col-1">
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    placeholder="Kode"
                                                                                                    maxlength="15"
                                                                                                    id="singlechoice-code[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                    value="{{ $pertanyaanGeneralOption['kode'] }}"
                                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyR }}][kode]">
                                                                                            </div>
                                                                                            <div class="col-3">
                                                                                                <input type="text"
                                                                                                    class="form-control"
                                                                                                    placeholder="Pilihan"
                                                                                                    value="{{ $pertanyaanGeneralOption['label'] }}"
                                                                                                    id="singlechoice-label[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyR }}][label]">
                                                                                            </div>
                                                                                            <div class="col-2">
                                                                                                <input type="text"
                                                                                                    class="form-control"
                                                                                                    placeholder="Nilai"
                                                                                                    value="{{ $pertanyaanGeneralOption['value'] }}"
                                                                                                    id="singlechoice-value[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyR }}][value]">
                                                                                            </div>
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    class="form-check">
                                                                                                    <input
                                                                                                        class="form-check-input singlechoice-addition "
                                                                                                        type="checkbox"
                                                                                                        {{ $pertanyaanGeneralOption['kode_input_tambahan'] == null ? '' : 'checked' }}
                                                                                                        id="singlechoice-addition[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyR }}][check_tambahan]">
                                                                                                    <label
                                                                                                        class="form-check-label"
                                                                                                        for="singlechoice-addition">
                                                                                                        Text Tambahan
                                                                                                    </label>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-2 singlechoice-addition-div"
                                                                                                id="singlechoice-addition-div[{{ $key }}][{{ $keyP }}][{{ $keyR }}]">
                                                                                                @if ($pertanyaanGeneralOption['kode_input_tambahan'] != null)
                                                                                                    <input
                                                                                                        class="form-control mutiplechoice-addition-text"
                                                                                                        type="text"
                                                                                                        value="{{ $pertanyaanGeneralOption['kode_input_tambahan'] }}"
                                                                                                        id="mutiplechoice-addition-text[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyR }}][kode_input_tambahan]"
                                                                                                        placeholder="Kode Text Tambahan">
                                                                                                @endif
                                                                                            </div>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <a class="btn btn-secondary btn-sm mx-1 collapsed"
                                                                                                        data-bs-toggle="collapse"
                                                                                                        href="#collapse[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                        role="button"
                                                                                                        aria-expanded="false"
                                                                                                ...
                                                                                                <a class="btn btn-danger btn-sm mx-1 delete-radio-option"
                                                                                                    id="delete-radio-option[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                    type="button">
                                                                                                    Hapus
                                                                                                </a>
                                                                                                <a class="btn btn-success btn-sm add-radio-option"
                                                                                                    id="add-radio-option[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                    type="button">
                                                                                                    Tambah
                                                                                                </a>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-12">
                                                                                                    <div class="input-group"
                                                                                                        ...
                                                                                                        <select
                                                                                                            class="form-select singlechoice-influence-show"
                                                                                                            id="singlechoice-influence-show[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                            data-placeholder="Tampilkan Pertanyaan"
                                                                                                            multiple="multiple">
                                                                                            ...
                                                                                            <div class="row mt-2">
                                                                                                <div class="col-12">
                                                                                                    <div class="input-group"
                                                                                                        ...
                                                                                                        <select
                                                                                                            class="form-select singlechoice-influence-hide"
                                                                                                            id="singlechoice-influence-hide[{{ $key }}][{{ $keyP }}][{{ $keyR }}]"
                                                                                                            data-placeholder="Sembunyikan Pertanyaan"
                                                                                                            multiple="multiple">
                                                                ...
                                                                @endif
                                                                @if ($pertanyaan['pertanyaan_general_option'][0]['tipe'] == 'mutiple')
                                                                    <div class="form-group inputtype checkbox-option-div"
                                                                        id="mutiplechoice_div[{{ $key }}][{{ $keyP }}]">
                                                                        <p> Silahkan isi opsi kotak centang dibawah
                                                                            ini <span class="text-danger">*</span>
                                                                        </p>
                                                                        @foreach ($pertanyaan['pertanyaan_general_option'] as $keyC => $pertanyaanGeneralOptionM)
                                                                            <div class="checkbox-option mutiple_option_div mt-2"
                                                                                id="mutiple_option_div[{{ $key }}][{{ $keyP }}][{{ $keyC }}]">
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="px-2">
                                                                                        <input class="form-check-input"
                                                                                            type="checkbox">
                                                                                        ...
                                                                                        <div class="row no-gutters">
                                                                                            <div class="col-1">
                                                                                                <input type="text"
                                                                                                    class="form-control"
                                                                                                    placeholder="Kode"
                                                                                                    value="{{ $pertanyaanGeneralOptionM['kode'] }}"
                                                                                                    id="mutiplechoice-code[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyC }}][kode]">
                                                                                            </div>
                                                                                            <div class="col-3">
                                                                                                <input type="text"
                                                                                                    class="form-control"
                                                                                                    placeholder="Pilihan"
                                                                                                    value="{{ $pertanyaanGeneralOptionM['label'] }}"
                                                                                                    id="mutiplechoice-label[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyC }}][label]">
                                                                                            </div>
                                                                                            <div class="col-2">
                                                                                                <input type="text"
                                                                                                    class="form-control"
                                                                                                    placeholder="Nilai"
                                                                                                    value="{{ $pertanyaanGeneralOptionM['value'] }}"
                                                                                                    id="mutiplechoice-value[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyC }}][value]">
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-2 d-flex align-items-center">
                                                                                                <div
                                                                                                    class="form-check">
                                                                                                    <input
                                                                                                        class="form-check-input mutiplechoice-addition"
                                                                                                        type="checkbox"
                                                                                                        {{ $pertanyaanGeneralOptionM['kode_input_tambahan'] == null ? '' : 'checked' }}
                                                                                                        id="mutiplechoice-addition[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyC }}][check_tambahan]">
                                                                                                    <label
                                                                                                        class="form-check-label"
                                                                                                        for="mutiplechoice-addition">
                                                                                                        Text Tambahan
                                                                                                    </label>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-2 mutiplechoice-addition-div"
                                                                                                id="mutiplechoice-addition-div[{{ $key }}][{{ $keyP }}][{{ $keyC }}]">
                                                                                                @if ($pertanyaanGeneralOptionM['kode_input_tambahan'] != null)
                                                                                                    <input
                                                                                                        class="form-control mutiplechoice-addition-text"
                                                                                                        type="text"
                                                                                                        value="{{ $pertanyaanGeneralOptionM['kode_input_tambahan'] }}"
                                                                                                        id="mutiplechoice-addition-text[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_general_option][{{ $keyC }}][kode_input_tambahan]"
                                                                                                        placeholder="Kode Text Tambahan">
                                                                                                @endif
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-2 d-flex align-items-center">
                                                                                                <a class="btn btn-white btn-sm  mx-1"
                                                                                                    type="button"
                                                                                                    style="visibility:hidden;">
                                                                                                    Hapus
                                                                                                </a>
                                                                                                <a class="btn btn-danger btn-sm  mx-1 delete-checkbox-option"
                                                                                                    id="delete-checkbox-option[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                    type="button">
                                                                                                    Hapus
                                                                                                </a>
                                                                                                <a class="btn btn-success btn-sm add-checkbox-option"
                                                                                                    id="add-checkbox-option[{{ $key }}][{{ $keyP }}][{{ $keyC }}]"
                                                                                                    type="button">
                                                                                                    Tambah
                                                                                                </a>
                                                                                            </div>
                                                            ...
                                                            @if (isset($pertanyaan['pertanyaan_grid_option']) &&
                                                                ...
                                                                <div class="form-group inputtype"
                                                                    id="gridcolumn_div[{{ $key }}][{{ $keyP }}]">
                                                                    <p> Silahkan isi opsi pilihan dibawah ini <span
                                                                            class="text-danger">*</span> </p>
                                                                    <div class="mx-3">
                                                                        <div class="row">
                                                                            <div
                                                                                class="col-lg-1 col-md-2 col-sm-2 py-3 bg-grey text-center">
                                                                                No
                                                                            </div>
                                                                            <div
                                                                                class="col-lg-5 col-md-5 col-sm-5 py-3 bg-grey text-center">
                                                                                Baris
                                                                            </div>
                                                                            <div
                                                                                class="col-lg-5 col-md-5 col-sm-5 py-3 bg-grey text-center">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-1 col-md-2 col-sm-2 py-3 text-center grid-number-container"
                                                                                ...
                                                                                <div class="row my-2 align-items-center grid-number-div"
                                                                                    data-row-number="{{ 1 + 1 }}"
                                                                                    id="grid-number-div[{{ $key }}][{{ $keyP }}][{{ 1 }}]">
                                                                                    <p class="text-center grid-number">
                                                                                        1 </p>
                                                                                </div>
                                                                                <div class="row my-2 align-items-center grid-number-div"
                                                                                    id="grid-number-div[{{ $key }}][{{ $keyP }}][{{ 1 }}] data-row-number="{{ 1 + 1 }}">
                                                                                    <p class="text-center grid-number">
                                                                                        2 </p>
                                                                                </div>
                                                                            </div>
                                                                                        ...
                                                                                        <div class="row my-2 grid-row"
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        class="form-control grid-row-input-value"
                                                                                                        id="grid-row-input-value[{{ $key }}][{{ $keyP }}][{{ $keyG }}]"
                                                                                                        placeholder="Kode Baris 2"
                                                                                                        value="{{ $pertanyaanGeneralOptionG['value'] }}"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_grid_option][{{ $keyName }}][value]">

                                                                                                    <input
                                                                                                        type="text"
                                                                                                        class="form-control grid-row-input"
                                                                                                        id="grid-row-input[{{ $key }}][{{ $keyP }}][{{ $keyG }}]"
                                                                                                        placeholder="Pertanyaan Baris 2"
                                                                                                        value="{{ $pertanyaanGeneralOptionG['label'] }}"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_grid_option][{{ $keyName }}][label]">
                                                                                                    <input
                                                                                                        type="hidden"
                                                                                                        value="{{ $pertanyaanGeneralOptionG['tipe_grid'] }}"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_grid_option][{{ $keyName }}][tipe_grid]">
                                                                                                    <input
                                                                                                        type="hidden"
            ...
            return $option['tipe_grid'] === 'column';
                                                                                    ...
                                                                                    @if ($pertanyaanGeneralOptionG['tipe_grid'] == 'column')
                                                                                        ...
                                                                                        <div class="row my-2 grid-column"
                                                                                            id="grid-column[{{ $key }}][{{ $keyP }}][{{ $keyG }}]">
                                                                                            <div class="col-lg-12">
                                                                                                <div
                                                                                                    class="input-group ">
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        class="form-control grid-column-kode"
                                                                                                        id="grid-column-input[{{ $key }}][{{ $keyP }}][{{ $keyG }}]"
                                                                                                        placeholder="Jawaban Kolom 2"
                                                                                                        value="{{ $pertanyaanGeneralOptionG['label'] }}"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_grid_option][{{ $keyName }}][label]">
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        class="form-control grid-column-input"
                                                                                                        id="grid-column-input[{{ $key }}][{{ $keyP }}][[{{ $keyG }}]"
                                                                                                        placeholder="Jawaban Kolom 2"
                                                                                                        value="{{ $pertanyaanGeneralOptionG['label'] }}"
                                                                                                        name="data[{{ $key }}][pertanyaan][{{ $keyP }}][pertanyaan_grid_option][{{ $keyName }}][label]">
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        class="form-control grid-column-input-value"
                                                                                                        id="grid-column-input-value[{{ $key }}][{{ $keyP }}][[{{ $keyG }}]"
                                                                        ...
                                                                        <div class="row">
                                                                            <div
                                                                                class="col-lg-1 col-md-2 col-sm-2 py-3 ">

                                                                            </div>
                                                                            <div
                                                                                class="col-lg-5 col-md-5 col-sm-5 py-2 ">
                                                                                <a class="btn btn-primary btn-sm grid-add-row-button"
                                                                                    type="button"
                                                                            ...
                                                                            <div
                                                                                class="col-lg-5 col-md-5 col-sm-5 py-2">
                                                                                <a class="btn btn-primary btn-sm grid-add-column-button"
                                                                                    type="button"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="d-flex float-end">
                                                            <a class="mx-1 delete_card" type="button"
                                                                id="delete_card[{{ $key }}][{{ $keyP }}]">
                                                                <svg width="21" viewBox="0 0 24 24"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M19.3248 9.46826C19.3248 9.46826 18.7818 16.2033 18.4668 19.0403C18.3168 20.3953 17.4798 21.1893 16.1088 21.2143C13.4998 21.2613 10.8878 21.2643 8.27979 21.2093C6.96079 21.1823 6.13779 20.3783 5.99079 19.0473C5.67379 16.1853 5.13379 9.46826 5.13379 9.46826"
                                                                        stroke="#009A4B" stroke-width="1.5"
                                                                        stroke-linecap="round"
                                                                        stroke-linejoin="round">
                                                                    </path>
                                                                    <path d="M20.708 6.23975H3.75" stroke="#009A4B"
                                                            ...
                                                            <a class="mx-2 duplicate_card" type="button"
                                                                id="duplicate_card[{{ $key }}][{{ $keyP }}]">
                                                                <svg width="20px" height="20px"
                                                                    viewBox="0 0 32 32" version="1.1"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                    xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"
                                                                    fill="#009A4B" stroke="#009A4B">
                                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                                    <g id="SVGRepo_tracerCarrier"
                                                                        stroke-linecap="round"
                                                                        stroke-linejoin="round"></g>
                                                            ...
                                                            <div class="form-check form-switch mx-2">
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="wajibdiisi[{{ $key }}][{{ $keyP }}]"
                                                                    {{ $pertanyaan['wajib_dijawab'] == '1' ? 'checked' : '' }}
                                                                    name="data[{{ $key }}][pertanyaan][{{ $keyP }}][wajib_dijawab]">
                                                                <label class="form-check-label text-black">Wajib
                                                                    Diisi</label>
                                                            </div>
                                                            <div class="dropup mx-2 more_dropdown">
                                                                <a class="px-2" type="button"
                                                                    id="dropdownMenu[{{ $key }}][{{ $keyP }}]"
                                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                                    <span class="fa-solid fa-ellipsis-vertical"
                                                                        style="color: #009a4b;"></span>
                                                                </a>
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li><a class="dropdown-item add_heading"
                                                                            id="add_heading[{{ $key }}][{{ $keyP }}]"
                                                                            type="button"><svg fill="#009a4b"
                                                                    ...
                                                                    <li><a class="dropdown-item add_pertanyaan"
                                                                            id="add_pertanyaan[{{ $key }}][{{ $keyP }}]"
                                                                            type="button"><svg width="18px"
...
<script>
    ...
    */
    ...
    $(document).ready(function() {
        ...
        $(`#page-navigation\\[0\\]`).addClass("active");
        initializeCard()
        inputPageTitle();
    ...
    */
    ...
    function toggleInputs(selectElement) {
        ...
        if (matches) {
            ...
            const validationContainerDivs = $(
                `#validation_div\\[${indexPage}\\]\\[${indexCard}\\]`);
            const validationDivs = $(
                `#validation_short_input\\[${indexPage}\\]\\[${indexCard}\\]`);
            ...
            if (selectedElement.attr('class') === 'shortanswer') {
                ...
                const valiDation = `
                            <div class="validation_short_input" id="validation_short_input[${indexPage}][${indexCard}]">
                ...
                if (validationDivs.length === 0) {

                    validationContainerDivs.append(valiDation);
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 col-lg-2">
                        ...
                        <div class="selectTypeJawaban_div" id="selectTypeJawaban_div[${indexPage}][${indexCard}]">
                            ...
                            <div class="validation_div" id="validation_div[${indexPage}][${indexCard}]">
