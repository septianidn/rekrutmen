                ...
                <div class="form-card text-start">
                    <div class="row">
                        <div class="col-sm-12 col-lg-12" id="card_container[${page}]">
                            <div class="card card-soal" data-id="1" id="card-soal[1]">
                                <div class="d-flex justify-content-center align-items-center drag-icon" id="drag-icon[1]">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label class="form-label text-black">Judul page ${page}</label>
                                                <input class="form-control" name="judul" placeholder="Isi Judul" id="judul[1]">
                                        </div>
                                    </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="d-flex float-end">
                                            <a class="mx-1 delete_card" type="button" id="delete_card[1]">
                                            ...
                                            <a class="mx-2 duplicate_card" type="button" id="duplicate_card[1]">                  
