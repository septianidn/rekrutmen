<div class="flex align-items-center list-paket-soal-action">
    ...
    <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" href="{{ route('backoffice.paket-soal.edit', $id) }}" title="Duplicate">                 
 ...
 <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" href="{{ route('backoffice.paket-soal.edit', $id) }}" title="Edit">                 
        <span class="btn-inner">
    ...
    function showDeleteConfirmation(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = "{{route('backoffice.paket-soal.destroy', '')}}/" + id;
                form.method = 'POST';
