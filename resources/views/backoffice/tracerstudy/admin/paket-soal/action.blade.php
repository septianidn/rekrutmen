<div class="flex align-items-center list-paket-soal-action">
 ...
 <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" href="{{ route('paket-soal.edit', $id) }}" title="Edit">                 
    ...
    <?php 
    $message = __('global-message.delete_alert', ['form' => __('paketsoal.title')])
    ?>
...
<script>
    function showDeleteConfirmation(id) {
        var message = "{!! __('global-message.delete_alert', ['form' => __('paketsoal.title')]) !!}";
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = "{{route('paket-soal.destroy', '')}}/" + id;
                form.method = 'POST';
