<x-app-layout :assets="$assets ?? []">
    <div>
       ...
       ?>
       @if(isset($id))
       {!! Form::model($data, ['route' => ['kelola.update', $id], 'method' => 'patch' , 'enctype' => 'multipart/form-data']) !!}
       @else
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="alias_url">Alias URL <span class="text-danger">*</span></label>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="d-flex justify-content-between">
                                                    <button type="submit" class="btn  btn-soft-light">Save Draft</button>
                                                    <button type="button" class="btn btn-soft-light">Preview</button>
                                                </div>
                                ...
                                <div class="accordion" id="kategori">
                                    <div class="accordion-item">
                                        <h4 class="accordion-header" id="headingKategori">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseKategori" aria-expanded="true" aria-controls="collapseKategori">
                                               Kategori
                                            </button>
                                        </h4>
                                        <div id="collapseKategori" class="accordion-collapse collapse show" aria-labelledby="headingKategori" data-bs-parent="#kategori">
                                            <div class="accordion-body">
                                                <div class="form-group">
                                                    <label class="form-label" for="grup_konten_id">Grup Konten</label>
                                                    {{ Form::select('grup_konten_id',  $grupKontenOptions->pluck('nama_grup', 'id')->toArray(), old('grup_konten_id'), [
                                                        'class' => 'form-control select-grup-konten',
                                                        'id' => 'grup_konten_id',
                                                    ]) }}
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label" for="kategori_konten_id">Kategori Konten </label>
                                                    {{ Form::select('kategori_konten_id', $kategoriKontenOptions->pluck('nama_kategori', 'id')->toArray(), old('kategori_konten_id'), [
                            ...
                            <div class="bd-example mt-2">
                                <div class="accordion" id="tagsParent">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTags" class="accordion-collapse collapse show" aria-labelledby="headingTags" data-bs-parent="#tagsParent">
                                            <div class="accordion-body">
                                                <div class="form-group">
                                                     {{ Form::text('tags', old('tags'), ['class' => 'form-control', 'placeholder' => 'Isi tags', 'id' => 'tags']) }}
                                                    <p  class="mt-2"><small>Jika tag lebih dari satu, pisah dengan tanda koma.</small></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion" id="gambarParent">
                                    <div class="accordion-item">
                                        <h4 class="accordion-header" id="headingGambar">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseGambar" aria-expanded="true" aria-controls="collapseGambar">
                                               Gambar Headline
                                            </button>
                                        </h4>
                                        <div id="collapseGambar" class="accordion-collapse collapse show" aria-labelledby="headingGambar" data-bs-parent="#gambarParent">
                                            <div class="accordion-body">
                                                <div class="bd-example">
                                                    <figure class="figure">
   ...
   function generateAliasURL(judul) {
        ...
        $('.select-grup-konten').on('change', function() {
            ...
            filteredKategoriOptions.forEach(function(kategori) {
                $('.select-kategori-konten').append(new Option(kategori.nama_kategori, kategori.id, false, false));
            });
