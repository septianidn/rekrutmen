<div class="flex align-items-center list-provinsi-action">
    ...
    ?>
    <a class="btn btn-sm btn-icon btn-danger" onclick="showDeleteConfirmation({{ $data->kode_provinsi }})"
        data-bs-toggle="tooltip" title="Hapus provinsi" href="#">
        <span class="btn-inner">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                stroke="currentColor">
                <path
...
<script>
    function showDeleteConfirmation(kode_provinsi) {
