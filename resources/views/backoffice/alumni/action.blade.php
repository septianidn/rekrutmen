...
<div class="flex align-items-center list-alumni-action">
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-modal-form="form" data-icon="person_add"  data--href="{{ route('backoffice.databasealumni.edit', $data->nim) }}" data-app-title="Edit Data Alumni" data-placement="top" title="Edit">                 
    ...
    function showDeleteConfirmation(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = "{{route('backoffice.databasealumni.destroy', '')}}/" + id;
                form.method = 'POST';
