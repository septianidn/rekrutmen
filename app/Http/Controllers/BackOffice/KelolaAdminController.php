...
class KelolaAdminController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('kelolaadmin.form', compact('roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view('kelolaadmin.profile', compact('data', 'profileImage'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('kelolaadmin.form', compact('data','id', 'roles', 'profileImage'));
    }
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        if(auth()->check()){
            return redirect()->route('kelolaadmin.index')->withSuccess(__('message.msg_updated',['name' => __('message.user')]));
        }
